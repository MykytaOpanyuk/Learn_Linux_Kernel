...
static dma_addr_t mem_base_2 = 0x9f202000;
static dma_addr_t reg_base_2 = 0x9f203000;
...
static u32 plat_dummy_mem_write8(struct plat_dummy_device *my_dev, u32 offset, u8 val)
{
...
static int plat_dummy_probe(struct platform_device *pdev)
{
	...
	pr_info("Memory mapped to %px\n", my_device->regs);
	pr_info("Registers mapped to %px\n", my_device->mem);
